...
print(optimalSubsample_bruteforce([1, 1.1, 3.9, 4, 100], 3))
print(optimalSubsample_bruteforce([1, 1.1, 3.9, 4, 100], 4))
...
print(optimalSubsample([1, 1.1, 3.9, 4], 3))
print(optimalSubsample([1, 1.1, 3.9, 4], 4))
